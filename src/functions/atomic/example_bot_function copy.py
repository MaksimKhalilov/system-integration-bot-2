...
import sys
sys.path.append('C:/User/student/Desktop/Art/Art')
...
def get_exhibitions():
    # URL API Art Institute of Chicago для получения выставок
    ...
    try:
        ...
        # Проверяем, есть ли данные о выставках
        if 'data' in data:
            ...
            for exhibition in exhibitions:
                ...
                exhibition_list.append(exhibition_info)
